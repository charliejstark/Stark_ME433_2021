...
void i2c_write(unsigned char address, unsigned char reg, unsigned char val) {

    //unsigned char writeBit = 0b01000000;
    unsigned char writeBit = address;
    
    
    i2c_master_start();
    
    i2c_master_send(writeBit);
    i2c_master_send(reg);
    i2c_master_send(val);
...
unsigned char i2c_read(unsigned char address, unsigned char reg) {
    ...
    //unsigned char writeBit = 0b01000000;
    //unsigned char readBit  = 0b01000001;
    
    unsigned char writeBit = address;
    unsigned char readBit  = address | 0b1;
    ...
    i2c_master_send(reg);
    i2c_master_restart();
    i2c_master_send(readBit);
    
    unsigned char val = i2c_master_recv();
